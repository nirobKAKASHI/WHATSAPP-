    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(botNumber, { 
                ...
                \n Give a Star ⭐ to our bot:\n https://github.com/deepdia\n ✅Make sure to join below channel`,
                contextInfo: {
                    forwardingScore: 999,
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '120363161513685998@newsletter',
                        newsletterName: 'DarkDeep Bot',
                        serverMessageId: -1
                    }
                }
            });
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: DEEP KUMAR DUTTA`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: DEEPDIA`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: KEPLAR WORLD`))
